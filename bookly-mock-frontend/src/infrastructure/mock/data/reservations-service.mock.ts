...
export const mockReservations: Reservation[] = [
  ...
  // Reservas con fechas dinámicas futuras para check-in
  {
    id: "rsv_100",
    resourceId: "res_001",
    resourceName: "Aula 101",
    ...
    userName: "Dr. Carlos Rodríguez",
    userEmail: "carlos.rodriguez@ufps.edu.co",
    title: "Clase de Algoritmos Avanzados",
    description: "Sesión de repaso antes del parcial",
    startDate: new Date(Date.now() + 10 * 60 * 1000).toISOString(),
    endDate: new Date(Date.now() + 130 * 60 * 1000).toISOString(),
    status: "CONFIRMED",
    attendees: 35,
  ...
  },
  {
    ...
    userEmail: "carlos.rodriguez@ufps.edu.co",
    title: "Práctica de Bases de Datos",
    description: "Ejercicio práctico de consultas SQL avanzadas",
  ...
  },
  {
    ...
    description: "Presentación de avances de proyectos de grado",
