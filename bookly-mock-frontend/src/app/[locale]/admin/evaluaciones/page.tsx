...
const mockEvaluations: UserEvaluation[] = [
  ...
  },
  {
    ...
    complianceScore: 3.0,
    careScore: 4.5,
    punctualityScore: 2.5,
    overallScore: 3.3,
    totalReservations: 12,
    evaluatedAt: "2026-02-08",
  },
  {
    id: "ev-3",
    userId: "u-3",
      ...
      {[1, 2, 3, 4, 5].map((s) => (
        <Star
          ...
          className={cn(
            "h-3.5 w-3.5",
            s <= Math.round(score)
              ? "text-state-warning-400 fill-yellow-400"
              ...
              <tbody>
                {filtered.map((ev) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-3">
                      <ScoreStars score={ev.complianceScore} />
                    </td>
                    <td className="px-4 py-3">
                      <ScoreStars score={ev.careScore} />
                    </td>
                    <td className="px-4 py-3">
                      <ScoreStars score={ev.punctualityScore} />
                    </td>
                    <td className="px-4 py-3">
                        ...
                        <span
                          className={cn(
                            ...
                            ev.overallScore >= 4
                              ...
                              : ev.overallScore >= 3
                                ? "bg-state-warning-100 text-state-warning-700"
