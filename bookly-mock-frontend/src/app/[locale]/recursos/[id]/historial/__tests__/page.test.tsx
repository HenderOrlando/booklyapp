...
jest.mock("@/infrastructure/http/httpClient", () => ({ httpClient: { get: jest.fn().mockResolvedValue({ success: true, data: { id: "res_001", name: "Sala A101", code: "SALA-101", type: "CLASSROOM" } }), post: jest.fn(), put: jest.fn(), patch: jest.fn(), delete: jest.fn() }, isMockMode: () => true }));

import HistorialPage from "../page";

describe("HistorialPage (RF-11)", () => {
  it("renders page content", async () => {
    render(<HistorialPage params={{ id: "res_001" }} />);
    await waitFor(() => {
