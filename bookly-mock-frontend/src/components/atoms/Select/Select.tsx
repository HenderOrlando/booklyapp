...
/**
 * Select Component - Bookly Design System
 *
 * Selector personalizado para formularios
 * Usado en: filtros, formularios, configuraciones
 *
 * Estados según sistema de diseño:
 * - default: borde border.subtle
 * - focus: borde border.focus (azul)
 * - error: borde state.error.border
  ...
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={cn(
        ...
        "bg-[var(--color-bg-[var(--)]color-bg[var(--co-or-bordrrface)] )]border-[var(--color-border-subtle)]",
        "text-[var(--[olvr-r(x-color-te)]xt-primary)]",
