...
/**
 * ReferenceData Controller — Reports Domain
 * Gestiona datos de referencia dinámicos del dominio de reportes:
 * feedback_type, feedback_category, export_format, report_type, etc.
 */
...
export class ReferenceDataController {
  ...
  @ApiQuery({ name: "group", required: false, example: "feedback_type" })
