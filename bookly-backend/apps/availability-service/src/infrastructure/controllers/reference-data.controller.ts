...
/**
 * ReferenceData Controller — Availability Domain
 * Gestiona datos de referencia dinámicos del dominio de disponibilidad:
 * reservation_status, recurrence_type, slot_status, week_day, exception_reason, etc.
 */
...
export class ReferenceDataController {
  ...
  @ApiQuery({ name: "group", required: false, example: "reservation_status" })
