...
/**
 * DropdownMenu Component - Bookly Design System
 *
 * Menú desplegable para acciones contextuales
 * Usado en: menús de usuario, acciones de tabla, opciones de recursos
 *
 * Tokens aplicados:
 * - Fondo: bg.surface
 * - Borde: border.subtle
...
>(({ className, inset, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ...
    className={cn(
      ...
      "focus:bg-[var(--color-bg-muted)] data-[state=open]:bg-[var(--color-bg-muted)]",
