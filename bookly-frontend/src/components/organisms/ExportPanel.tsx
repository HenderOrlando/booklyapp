...
export const ExportPanel = React.memo<ExportPanelProps>(
  ({
    ...
    return (
      <div
        className={`bg-[var(--color-bg-surface)] border border-[var(--color-border-subtle)] rounded-lg p-6 ${className}`}
      >
        <div className="flex items-center gap-2 mb-6">
          <FileDown className="h-5 w-5 text-[var(--color-text-secondary)]" />
              ...
              <div className="space-y-2">
                <label className="flex items-center gap-2 cursor-pointer">
                  <input
                    ...
                    className="rounded border-[var(--color-border-strong)] text-[var(--color-action-primary)] focus:ring-[var(--color-border-focus)]"
                  />
