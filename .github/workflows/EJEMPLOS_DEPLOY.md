...
on:
  push:
    branches:
      ...
      - develop
    paths:
      - 'bookly-backend/apps/api-gateway/**'
      - 'bookly-backend/libs/**'
      - 'ci-cd/bookly-backend/dockerfiles/Dockerfile.gateway'
...
jobs:
  build:
    ...
    with:
      ...
      dockerfile-path: ci-cd/bookly-backend/dockerfiles/Dockerfile.gateway
      context-path: bookly-backend
