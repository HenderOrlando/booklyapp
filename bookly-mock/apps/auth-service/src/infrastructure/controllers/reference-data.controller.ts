...
/**
 * ReferenceData Controller — Auth Domain
 * Gestiona datos de referencia dinámicos del dominio de autenticación:
 * user_role, audit_action
 */
...
export class ReferenceDataController {
  ...
  @ApiOperation({
    ...
    description: "Retorna los nombres de todos los grupos disponibles en el dominio de auth",
  })
  ...
  @ApiQuery({ name: "group", required: false, description: "Filtrar por grupo", example: "user_role" })
  ...
  @ApiParam({ name: "id", description: "ID del dato de referencia" })
  @ApiResponse({ status: 200, description: "Dato actualizado" })
  @ApiResponse({ status: 404, description: "Dato no encontrado" })
  async update(
    @Param("id") id: string,
  ...
  @ApiParam({ name: "id", description: "ID del dato de referencia" })
  @ApiResponse({ status: 200, description: "Dato desactivado" })
  @ApiResponse({ status: 404, description: "Dato no encontrado" })
  async deactivate(
    @Param("id") id: string,
    @CurrentUser("sub") userId: string,
